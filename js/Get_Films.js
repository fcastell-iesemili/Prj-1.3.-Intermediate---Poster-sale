function Get_Film_01() {
    fetch("json/films.json")
        ...
        .then((data) => {
            ...
            <button data-toggle="modal" data-target="#exampleModalCenter" id="button_Terminator_Films" type="button" class="btn btn-info btn-sm">Comprar</button>
        ...
        .then((data) => {
            ...
            <div id="titles">
               ...
               <p>Duraccion: ${data.films['1'].duracion}</p>
                ...
                <button data-toggle="modal" data-target="#exampleModalCenter" id="button_Alien_Films" type="button" class="btn btn-info btn-sm">Comprar</button>
        ...
        .then((data) => {
            ...
            <div id="titles">
               ...
               <p>Duraccion: ${data.films['2'].duracion}</p>
                ...
                <button data-toggle="modal" data-target="#exampleModalCenter" id="button_Matrix_Films" type="button" class="btn btn-info btn-sm">Comprar</button>
              `
        });
}
